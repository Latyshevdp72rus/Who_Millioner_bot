...
class UserGame:
    def __init__(self, user_id):
        ...
        self.finish = False
        self.user_quest = []
        self.stages = {1: 1000, 2: 5000, 3: 15000, 4: 50000, 5: 75000, 6: 100000, 7: 125000, 8: 150000, 9: 200000,
                       10: 280000}
...
def render_fifth(quesi, step):
    questions = ['Пусто', 'Пусто', 'Пусто', 'Пусто']
    tmp_list = [0, 1, 2, 3]
...
def render_keyboard(user_obj: UserGame):
    ...
    btn4 = KeyboardButton('Банк: ' + str(user_obj.balance) + ' руб')
...
async def push_message(user_obj: UserGame, chat_id):
    user_obj.step += 1
    answer_cool = 'Вопрос на ' + str(user_obj.get_price_quest()) + ' руб'
